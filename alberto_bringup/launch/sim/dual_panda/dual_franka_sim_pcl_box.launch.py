...
def generate_launch_description():
    ...
    # node_robot_perception = Node(
    #     package='garmi_robot_perception',
    #     executable='proximity_task_generator',
    #     name='proximity_task_generator',
    #     namespace=ns,
    #     output='screen',
    #     parameters=[
    #         {'base_link_name': 'base_link'},
    #         {'load_gripper_left': load_gripper},
    #         {'load_gripper_right': load_gripper}
    #     ]
    # )
    ...
    rviz_file = os.path.join(get_package_share_directory('franka_description'), 'rviz',
                             'visualize_dual_franka_pcl.rviz')
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            ...
            default_value='"0.0 -0.485 0.0 -2.056 0.0 1.571 0.785"',
