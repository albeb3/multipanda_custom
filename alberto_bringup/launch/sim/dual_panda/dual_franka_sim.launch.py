...
def generate_launch_description():
    ...
    if(load_gripper): # mujoco scene file must be manually adjusted since there's no way to pass parameters
        ...
        scene_file = 'dual_scene_ng.xml'
    franka_xacro_file = os.path.join(get_package_share_directory('alberto_description'), 'robots', 'sim','dual_panda',
                                     "dual_panda_arm_sim.urdf.xacro")
    xml_file = os.path.join(get_package_share_directory('alberto_description'), 'mujoco', 'dual_panda','assets','xml', scene_file)
