...
def generate_launch_description():
    ...
    franka_xacro_file = os.path.join(get_package_share_directory('alberto_description'), 'robots', 'sim','panda',
                                     'panda_arm_sim.urdf.xacro')
    xml_file = os.path.join(get_package_share_directory('alberto_description'), 'mujoco', 'panda','assets','xml', scene_file)
